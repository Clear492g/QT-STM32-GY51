...
void I2C_Configuration(void)
{
   ...
   I2C_InitStructure.I2C_OwnAddress1 = L3G4200_Addr;
...
{
    I2C_WriteOneByte(I2C2,L3G4200_Addr,CTRL_REG1, 0x0f);
    I2C_WriteOneByte(I2C2,L3G4200_Addr,CTRL_REG2, 0x00);
    I2C_WriteOneByte(I2C2,L3G4200_Addr,CTRL_REG3, 0x08);
    I2C_WriteOneByte(I2C2,L3G4200_Addr,CTRL_REG4, 0x00);
    I2C_WriteOneByte(I2C2,L3G4200_Addr,CTRL_REG5, 0x00);
}
